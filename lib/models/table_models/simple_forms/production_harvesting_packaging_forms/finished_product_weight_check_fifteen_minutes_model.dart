class FinishedProductWeightCheckFifteenMinutesModel {
  final int? finishedProductWeightCheckFifteenMinId;
  final int client;
  final int farm;
  final int crop;
  final String? date;
  final String? fifteenMinWeightCheck;
  ...
  FinishedProductWeightCheckFifteenMinutesModel({
    required this.finishedProductWeightCheckFifteenMinId,
    required this.client,
    required this.farm,
    required this.crop,
    required this.date,
    required this.fifteenMinWeightCheck,
  ...
  factory FinishedProductWeightCheckFifteenMinutesModel.fromSqfliteDatabase(
          Map<String, dynamic> map) =>
      FinishedProductWeightCheckFifteenMinutesModel(
        finishedProductWeightCheckFifteenMinId:
            map["finished_product_weight_check_fifteen_min_id"],
        client: map["client"],
        farm: map["farm"],
        crop: map["crop"],
        date: map["date"],
        fifteenMinWeightCheck: map["fifteen_min_weight_check"],
  ...
  Map<String, String?> toJson() {
    return {
      ...
      "crop": crop.toString(),
      "date": date.toString(),
      "fifteen_min_weight_check": fifteenMinWeightCheck,
