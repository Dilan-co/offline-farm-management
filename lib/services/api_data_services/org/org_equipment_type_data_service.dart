...
class OrgEquipmentTypeDataService {
  final StateController stateController = Get.find();

  String get dataUrl => '${stateController.baseUrl}/sf-equipment-type';
  ...
  Future<bool> getData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<OrgEquipmentTypeModel> dataList = List<OrgEquipmentTypeModel>.from(
            responseDecoded
                .map((data) => OrgEquipmentTypeModel.fromJson(data)));
        // Attempt batch insert/update
        try {
          if (dataList.isNotEmpty) {
            await OrgEquipmentType().createRecordsBatch(models: dataList);
          }
        } catch (e) {
        ...
        debugPrint("GET ORG_equipment_type Data Sync Failed");
        return false;
      }
    } catch (e) {
      debugPrint("GET ORG_equipment_type Error : $e");
      return false;
    }
  }
}
