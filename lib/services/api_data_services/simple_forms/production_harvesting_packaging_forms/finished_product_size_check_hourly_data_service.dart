...
class FinishedProductSizeCheckHourlyDataService {
  final StateController stateController = Get.find();

  String get formDataUrl =>
      '${stateController.baseUrl}/sf-finished-product-size-check-hourly';
  ...
  Future<bool> postData() async {
    ...
    List<FinishedProductSizeCheckHourlyModel> recordList =
        await FinishedProductSizeCheckHourly()
            .fetchNotSyncedRecords();

    //Delete "delete_date" Expired Records
    FinishedProductSizeCheckHourly().deleteExpiredRecords();
          ...
          if (response.statusCode == 201 || response.statusCode == 200) {
            ...
            bool sig = await sendMultipartFormRequest(
              ...
              recordId: responseDecoded[
                  ...
                  .toString(),
              modelName: 'SFFinishedProductSizeCheckHourly',
              fieldName: 'signature',
              fileType: 'signature',
            ...
            debugPrint(
                'POST SIMPLE_FORM_finished_product_size_check_hourly Data Sync Failed: ${response.statusCode} - ${response.body}');
            return false;
          }
        } catch (e) {
          debugPrint(
              'POST SIMPLE_FORM_finished_product_size_check_hourly Error: $e');
          return false;
        }
      }
  ...
  addSyncAndExpireDate(
      {required FinishedProductSizeCheckHourlyModel record}) async {
    ...
    //Update Record
    int recId = await FinishedProductSizeCheckHourly()
