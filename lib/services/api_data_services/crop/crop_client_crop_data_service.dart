...
class CropClientCropDataService {
  final StateController stateController = Get.find();

  String get dataUrl => '${stateController.baseUrl}/client-crop';
  ...
  Future<bool> getData() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<CropClientCropModel> dataList = List<CropClientCropModel>.from(
            responseDecoded.map((data) => CropClientCropModel.fromJson(data)));
        // Attempt batch insert/update
        try {
          if (dataList.isNotEmpty) {
            await CropClientCrop().createRecordsBatch(models: dataList);
          }
        } catch (e) {
        ...
        debugPrint("GET CROP_client_crop Data Sync Failed");
        return false;
      }
    } catch (e) {
      debugPrint("GET CROP_client_crop Error : $e");
      return false;
    }
  }
}
