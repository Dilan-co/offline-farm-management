...
class WaterSourceInspectionLogView extends StatelessWidget {
  final String updateRouter;
  final WaterSourceInspectionLogModel data;
  final Function(bool, WaterSourceInspectionLogModel) onDelete;
  const WaterSourceInspectionLogView({
    super.key,
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: SimpleFormsAppBar(
            title: "Water Source Inspection Log", isView: true),
        //
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              FormViewTextRow(
                label: "Is Secure",
                data: data.isSecure == 1 ? "YES" : "NO",
              ),
              FormViewTextRow(
                label: "Is Authorized Access Permitted",
                data: data.isAuthorizedAccessPermitted == 1 ? "YES" : "NO",
              ),
              FormViewTextRow(
                label: "Is Free From Contamination",
                data: data.isFreeFromContamination == 1 ? "YES" : "NO",
              ),
