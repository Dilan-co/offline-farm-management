...
class EquipmentListView extends StatelessWidget {
  ...
  final Function(bool, OrgEquipmentModel) onDelete;
  ...
  Widget build(BuildContext context) {
    ...
    Future<bool> loadRecordData() async {
      try {
        equipmentTypeName =
            getValueForKey(data.equipmentTypeId, stateController.assetTypeList);
        equipmentManufacturerName = getValueForKey(data.equipmentManufacturerId,
            stateController.equipmentManufacturerNameList);
        debugPrint('$equipmentTypeName');
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: SimpleFormsAppBar(title: "Equipment", isView: true),
        //
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              FormViewTextRow(
                ...
                data: equipmentManufacturerName,
              ),
              FormViewTextRow(
                label: "Model",
                data: data.model,
              ...
              FormViewTextRow(
                ...
                data: data.manufactureYear,
              ),
              FormViewTextRow(
                label: "Date Of Purchase",
                data: data.dateOfPurchase,
              ),
              FormViewTextRow(
                label: "Person Responsible",
                data: data.personResponsible,
              ),
              FormViewTextRow(
                label: "Media",
                data: data.media,
