...
class HarvestRiskAssessmentView extends StatelessWidget {
  final String updateRouter;
  final HarvestRiskAssessmentModel data;
  final Function(bool, HarvestRiskAssessmentModel) onDelete;
  const HarvestRiskAssessmentView({
    super.key,
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              FormViewTextRow(
                label: "Block Range",
                data: data.blockRange,
              ),
              FormViewTextRow(
                label: "Harvest Date",
                data: data.harvestDate,
              ),
              FormViewTextRow(
                label: "Last Spray Date",
                data: data.lastSprayDateTime,
              ),
              FormViewTextRow(
                label: "Withhold Period Observed",
                data: data.withholdPeriodApplied,
              ),
              FormViewTextRow(
                label: "Safe Date to Harvest",
                data: data.safeDateToHarvest,
              ),
              FormViewTextRow(
                label: "Harvest Authorized By",
                data: data.harvestAuthorizedBy,
              ),
              FormViewTextRow(
                label: "Sprayed With (Chemical + WHP)",
                data: data.sprayedWith,
              ),
              FormViewTextRow(
                label: "Comment",
                data: data.comment,
              ...
              FormViewTextRow(
                ...
                data: (data.updatedBy ?? data.createdBy) == 0
                    ? ""
