...
class DailyScaleCheckRecordView extends StatelessWidget {
  final String updateRouter;
  final DailyScaleCheckModel data;
  final Function(bool, DailyScaleCheckModel) onDelete;
  const DailyScaleCheckRecordView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar:
            SimpleFormsAppBar(title: "Daily Scale Check Record", isView: true),
        //
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              FormViewTextRow(
                ...
                data: data.fivePointCheck,
              ),
              FormViewTextRow(
                label: "Test mass weight",
                data: data.testMassWeight,
              ),
              FormViewTextRow(
                label: "Scale reading",
                data: data.scaleReading,
              ),
              FormViewTextRow(
                label: "Comment",
                data: data.comment,
