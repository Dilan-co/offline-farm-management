...
class PLUStickerRecordView extends StatelessWidget {
  final String updateRouter;
  final PluStickerRecordModel data;
  final Function(bool, PluStickerRecordModel) onDelete;
  const PLUStickerRecordView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: SimpleFormsAppBar(title: "PLU Sticker Record", isView: true),
        //
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              FormViewTextRow(
                ...
                data: data.cassetteNumber,
              ),
              FormViewTextRow(
                label: "Line Clearance",
                data: data.lineClearance == 1 ? "YES" : "NO",
              ),
              ...
              FormViewTextRow(
                ...
                data: data.pluNew,
                isImage: true,
                imageFileName: data.pluNew,
              ),
              FormViewTextRow(
                label: "Plu Old",
                data: data.pluOld,
                isImage: true,
                imageFileName: data.pluOld,
              ),
