...
class PackagingTareWeightCheckView extends StatelessWidget {
  final String updateRouter;
  final PackagingTareWeightCheckModel data;
  final Function(bool, PackagingTareWeightCheckModel) onDelete;
  const PackagingTareWeightCheckView({
    super.key,
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: SimpleFormsAppBar(
            title: "Packaging Tare Weight Check", isView: true),
        //
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              FormViewTextRow(
                ...
                data: data.packagingFormat,
              ),
              FormViewTextRow(
                label: "Gross weight of finished product",
                data: data.grossWeightOfFinishedProduct,
              ),
              FormViewTextRow(
                label: "Weight of outer packaging",
                data: data.weightOfOuterPackaging,
              ),
              FormViewTextRow(
                label: "Weight of liner",
                data: data.weightOfLiner,
              ),
              FormViewTextRow(
                label: "Weight of primary packaging",
                data: data.weightOfPrimaryPackaging,
              ),
              FormViewTextRow(
                label: "Total weight of packaging",
                data: data.totalWeightOfPackaging,
              ),
              FormViewTextRow(
                label: "Net weight of product",
                data: data.netWeightOfProduct,
              ),
              FormViewTextRow(
                label: "Weight claimed on label or packaging",
                data: data.weightClaimedOnLabelOrPackaging,
              ),
              FormViewTextRow(
                label: "Check weight again",
                data: data.checkWeightAgain == 1 ? "YES" : "NO",
              ),
              FormViewTextRow(
                label: "Comment",
                data: data.comment,
